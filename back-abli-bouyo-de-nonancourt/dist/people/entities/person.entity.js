...
__decorate([
    swagger_1.ApiModelProperty({ description: 'Photo URL', example: 'https://randomuser.me/portraits/men/55.jpg' }),
    class_transformer_1.Expose(),
    class_transformer_1.Type(() => String),
    __metadata("design:type", String)
...
__decorate([
    swagger_1.ApiModelProperty({ description: 'Entity where person works', example: 'UTARA' }),
    class_transformer_1.Expose(),
    class_transformer_1.Type(() => String),
    __metadata("design:type", String)
], PersonEntity.prototype, "entity", void 0);
__decorate([
    swagger_1.ApiModelProperty({ description: 'Birthdate in timestamp format', example: '101343600000' }),
    class_transformer_1.Expose(),
...
__decorate([
    swagger_1.ApiModelProperty({ description: 'Flag to know if this person is a manager', example: false }),
    class_transformer_1.Expose(),
