...
export class PeopleController {
  ...
  @ApiUnprocessableEntityResponse({ description: 'The request can\'t be performed in the database' })
  @ApiImplicitBody({ name: 'CreatePersonDto', description: 'Payload to create a new person', type: CreatePersonDto })
  @Post()
  ...
  @ApiUnprocessableEntityResponse({ description: 'The request can\'t be performed in the database' })
  @ApiImplicitParam({ name: 'id', description: 'Unique identifier of the person in the database', type: String })
  @ApiImplicitBody({ name: 'UpdatePersonDto', description: 'Payload to update a person', type: UpdatePersonDto })
  @Put(':id')
